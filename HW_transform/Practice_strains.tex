...
\item \textbf{Question:} Make a graphical representation of the reference configuration and of the deformed configuration for some specific values ($\beta=0$, $\beta=0.025$, \dots)? 
\item \textbf{Question:} What is the value of the local variation of volume? 
\item \textbf{Question:} What is the maximum admissible value for $\beta$ so the transformation has any physycal sense?
\end{description}

\begin{description}
	\item \textbf{Answer:} The gradient of transformation?
...
\begin{description}
	...
	\item \textbf{Answer:} We define the original shape as a $10\times10\times10 mm^3$ cube. Fig. \ref{fig:1} (a) gives the original and deformed shape with $\beta=0$. Since the coordinate in the third direction is not changed, we can see it as a 2D deformation problem and make the comparison more clear, like in Fig. \ref{fig:1} (b). Fig. \ref{fig:2} (a)-(d) shows the reference and deformed configuration with $\beta=0, 0.01, 0.025, 0.05$ respectively.
	
	\begin{figure}
		\centering
		\subfloat[][$\beta=0$]{\includegraphics[width=.45\textwidth]{1.png}}\quad
		\subfloat[][$\beta=0.01$]{\includegraphics[width=.45\textwidth]{1_1.png}}\quad
...
\begin{description}
	...
	\item \textbf{Answer:} The local variation of volume is the determinant of $\underline{\underline{F}}$ at every point of the reference configuration. Fig. \ref{fig:3} (a)-(d) show the local variation of volume with $\beta= 0, 0.01, 0.025, 0.05$ respectively.
...
\begin{description}
	\item \textbf{Answer:} To make the transformation physical sounds, the determinant of $\underline{\underline{F}}$ should be larger than zero. Otherwise, the deformed volume will be negative, which doesn't make sense.
