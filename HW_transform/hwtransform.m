...
title(['Reference and deformed configuration with ','\beta: ',num2str(beta)]);
hold on;
...
% - we buikd the deformed configuration
    ...
    hold on;
    plot(Tx1,Tx2,'.r');axis equal; axis([0 30 0 30]); box on;grid on;
...
% - we plot the volume variation
    ...
    title(['Local volume variations with ','\beta: ',num2str(beta)]);