...
\begin{description}
\item \textbf{Question 1:} Make a graphical representation of the reference configuration and of the deformed configuration. Calculate the gradient of the transformation, $\TT{F}$.
\item \textbf{Question 2:} Is this an homogenous transformation? It is acceptable from a physical point of view?
\item \textbf{Question 3:} Calculate the expansion of the following vectors: $\T{e}_1$, $\T{e}_2$ and $\frac{\T{e}_1+\T{e}_2}{\sqrt{2}}$
\item \textbf{Question 4:} Calculate $\TT{e}$ and $\TT{\varepsilon}$? Can we consider we are in small perturbations?
\item \textbf{Question 5:} Consider the transformation $x_1=X_1+\alpha \cdot X_2$, $x_2=X_2$ and $x_3=X_3$. What is the condition for having small perturbations?
\end{description}
