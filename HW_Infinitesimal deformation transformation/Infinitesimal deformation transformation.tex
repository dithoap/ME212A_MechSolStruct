...
\item \textbf{Answer:} 
	...
	{{\lambda }^{2}}{{\cos }^{2}}\theta +{{\sin }^{2}}\theta  & \left( 1-{{\lambda }^{2}} \right)\sin \theta \cos \theta  & 0  \\
	\left( 1-{{\lambda }^{2}} \right)\sin \theta \cos \theta  & {{\lambda }^{2}}si{{n}^{2}}\theta +{{\cos }^{2}}\theta  & 0  \\
	0 & 0 & 1  \\
	\end{matrix} \right]
	\end{equation}
\end{description}
...
\item \textbf{Answer:} 
	...
	\left( {{\lambda }^{2}}-1 \right){{\cos }^{2}}\theta  & \left( 1-{{\lambda }^{2}} \right)\sin \theta \cos \theta  & 0  \\
	\left( 1-{{\lambda }^{2}} \right)\sin \theta \cos \theta  & \left( {{\lambda }^{2}}-1 \right)si{{n}^{2}}\theta  & 0  \\
	0 & 0 & 0  \\
	\end{matrix} \right]
	\end{equation}
\end{description}
...
\item \textbf{Answer:} 
	\begin{equation}
	\begin{aligned}
	& \left\| \underline{\underline{e}} \right\|={{\left( {{\lambda }^{2}}-1 \right)}^{2}}\left( {{\cos }^{4}}\theta +{{\sin }^{4}}\theta +2{{\sin }^{2}}\theta {{\cos }^{2}}\theta  \right) \\ 
	& ={{\left( {{\lambda }^{2}}-1 \right)}^{2}}{{\left( {{\sin }^{2}}\theta +{{\cos }^{2}}\theta  \right)}^{2}} \\ 
	& ={{\left( {{\lambda }^{2}}-1 \right)}^{2}}\ll 1 \\ 
	\end{aligned}	
	\end{equation}
